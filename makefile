...
#main rule
gerp: main.o HashMap.o DirNode.o FSTree.o wordHash.o stringProcessing.o
	$(CXX) $(LDFLAGS) -o gerp main.o HashMap.o DirNode.o FSTree.o wordHash.o stringProcessing.o
...
#Rule for main.o
main.o: main.cpp HashMap.cpp DirNode.h FSTree.h
